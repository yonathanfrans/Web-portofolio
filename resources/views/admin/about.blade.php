...
<body>
    ...
    <div class="d-flex">
        <div class="d-flex flex-column flex-shrink-0 p-3 text-bg-dark sticky-top" style="width: 250px; height: 100vh;">
            ...
            <li>
                <a href="/admin/about" class="nav-link active text-white d-flex align-items-center">
        ...
        <div class="flex-grow-1 p-5 text-light" style="background-color: #1C1C1C;">
            ...
            <table class="table">
                ...
                <tr>
                    ...
                    <td class="text-truncate" style="max-width: 150px;">{{ $about->achievement }}</td>
                    <td class="text-truncate" style="max-width: 150px;">{{ $about->path }}</td>
                    <td class="text-truncate" style="max-width: 150px;">{{ $about->content }}</td>
                    <td>
                    <button type="button" class="btn-edit btn btn-primary btn-sm" data-id="{{ $about->id }}" data-achievement="{{ $about->achievement }}" data-path="{{ $about->path }}" data-content="{{ $about->content }}">
                        <i class='bx bx-pencil'></i>
                    </button>
                    <button type="button" class="btn-delete btn btn-danger btn-sm" data-id="{{ $about->id }}" >
        ...
        <div class="modal fade" id="modalEdit" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                ...
                <form action="/admin/editAbout" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                        @csrf

                        <input type="hidden" name="id" id="edit-id">
                        <div class="form-floating py-2">
                            <input type="text" name="achievement" class="form-control" id="edit-achievement" required>
                            <label for="edit-achievement">Achievement</label>
                        </div>
                        <div class="form-floating py-2">
                        ...
                        <div class="form-floating py-2">
                            <label for="edit-file" class="form-label">Input File</label>
                            <input class="form-control" type="file" id="edit-file" name="path">
                        </div>
        ...
        <div class="modal fade" id="modalCreate" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                ...
                <form action="/admin/createAbout" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                        @csrf

                        <div class="form-floating py-2">
                            <input type="text" name="achievement" class="form-control" id="create-achievement" required>
                            <label for="create-achievement">Achievement</label>
                        </div>
                        <div class="form-floating py-2">
                            <label for="create-file" class="form-label">Input File</label>
                            <input class="form-control" type="file" id="create-file" name="path">
                        </div>
                        <div class="form-floating">
        ...
        <div class="modal fade" id="modalDelete" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                ...
                <form action="/admin/deleteAbout" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                       @method('delete')
                        @csrf
    ...
    $(document).ready(function () {
        $('.btn-edit').on('click', function () {
            const fileNamePath = $(this).data('path');
            ...
            $('#edit-achievement').val($(this).data('achievement'));
